...
@section('title', $material->name . ' Edit | ')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{ route('material.update',['material' => $material->id]) }}" method="POST"
                        ...
                        <div class="form-floating form-floating-outline">
                            ...
                            >
                                ...
                                @foreach($categories as $model)
                                    <option
                                            value="{{ $model->id }}" @selected(old('category_id',$material->category_id) == $model->id)>{{ $model->name }}</option>
                                @endforeach
                            </select>
