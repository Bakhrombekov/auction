...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form class="app-ecommerce was-validated" action="{{ route('product.update',['product' => $product->id]) }}"
              method="POST"
            ...
            <div
                ...
                <div class="d-flex flex-column justify-content-center">
                    <h4 class="mb-1">Edit a Product for {{ $product->category->name }} category</h4>
                ...
                <div class="d-flex align-content-center flex-wrap gap-4">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="ri-save-3-line me-2"></i> Save</button>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="text-center mb-3">
                                @if($product->image !== null)
                                    <img src="{{ asset($product->image) }}" alt="image" class="w-50">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-floating form-floating-outline mb-5">
                                <input
                                    ...
                                    value="{{ old('auction_date', $product->auction_date->format('Y-m-d')) }}"
                                />
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    >
                                        ...
                                        @foreach($categories as $model)
                                            <option
                                                value="{{ $model->id }}" @selected(old('category_id', $product->category->id) == $model->id)>{{ $model->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    >
                                        ...
                                        @foreach($classifications as $classification)
                                            <option
                                                @selected(old('classification_id', $product->classification_id) == $classification->id)
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    >
                                        ...
                                        @foreach($materials as $material)
                                            <option
                                                value="{{ $material->id }}" @selected(old('material_id', $product->material_id) == $material->id)>{{ $material->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-floating form-floating-outline">
                                    ...
                                    >
                                        ...
                                        @foreach($statuses as $status)
                                            <option
                                                value="{{ $status->id }}" @selected(old('status_id',$product->status_id) == $status->id)>{{ $status->name }}</option>
                                        @endforeach
                                    </select>
